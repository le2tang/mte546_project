...
class PoseModel:
    ...
    def forward_model(self, state):
        ...
        new_quat = self._state_orientation(state) + self.dt * 0.5 * self._quat_derivative(q, w)
    ...
    def measurement_model(self, state):
        ...
        return np.concatenate((self._state_position(state), self._state_orientation(state)))
